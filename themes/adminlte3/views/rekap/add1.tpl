              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                {foreach from=$spb item=c}
                  ...
                  <tr>
                    <td>{counter}</td>
                    <td>{$nama} </td>
                    <td class="text-right">{$c->banyak}</td>
                    <td class="text-right">{$c->total|number_format}</td>
                    <td class="text-center">
                        <a href="{base_url('rekapinv/add2/')}{$c->customer_id}" class="text-success"><i class="fa fa-check"></i> </a>&nbsp;
                    </td>
                  </tr>
                {/foreach}
                </tbody>
